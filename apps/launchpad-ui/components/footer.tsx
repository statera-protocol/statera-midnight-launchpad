    ...
    <footer className="border-t border-gray-800 bg-gray-900/50 backdrop-blur-sm mt-auto">
      <div className="container mx-auto px-4 py-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            ...
            <p className="text-gray-400 text-sm">
              The premier launchpad for innovative projects on the Midnight blockchain.
            </p>
          </div>
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-2">
              <Link href="/" className="block text-gray-400 hover:text-gray-200 text-sm transition-colors">
                Dashboard
              </Link>
              <Link href="/projects" className="block text-gray-400 hover:text-gray-200 text-sm transition-colors">
                Projects
              </Link>
              <Link
              ...
              <Link href="/create-sale" className="block text-gray-400 hover:text-gray-200 text-sm transition-colors">
                Create Sale
              </Link>
            </div>
          </div>
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-2">
              <a href="#" className="block text-gray-400 hover:text-gray-200 text-sm transition-colors">
                Documentation
              </a>
              <a href="#" className="block text-gray-400 hover:text-gray-200 text-sm transition-colors">
                API Reference
        ...
        <div className="border-t border-gray-800 mt-8 pt-6 flex flex-col md:flex-row justify-between items-center">
          <p className="text-gray-400 text-sm">© 2024 Midnight Launchpad. All rights reserved.</p>
