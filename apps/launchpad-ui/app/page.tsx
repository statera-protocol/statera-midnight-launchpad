    ...
    <div className="min-h-screen bg-gray-900 text-gray-100">
      ...
      <main className="flex flex-col">
        ...
        <section className="min-h-screen flex flex-col justify-center container mx-auto px-4 py-8">
          ...
          {/* Stats */}
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-12 mx-auto w-auto">
            <Card className="bg-gray-800/50 border-gray-700 max-w-[20em] w-screen">
            ...
            <Card className="bg-gray-800/50 border-gray-700 max-w-[20em]">
              <CardContent className="p-6">
                <div className="flex items-center justify-between">
                  <div>
                  ...
                  >
                    ...
                    <CardContent>
                      <Link href="/create-sale">
                        <Button
                          className="w-full bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700 group-hover:shadow-lg group-hover:shadow-purple-500/25 text-white"
